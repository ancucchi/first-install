...
winget install --no-upgrade -e --id Balena.Etcher 
...
winget install --no-upgrade -e --id TheDocumentFoundation.LibreOffice 
...
winget install --no-upgrade -e --id Beeper.Beeper 
...
winget install --no-upgrade -e --id SumatraPDF.SumatraPDF 
winget install --no-upgrade -e --id TechPowerUp.GPU-Z 
...
@echo ---------------------------
@echo digitare da  riga di comando 
@echo ---------------------------
